return {{
    ...
    config = function()
        ...
        ts_config.setup {
            ...
            "bash", "c", "go", "gomod", "gosum", "gotmpl", "javascript", "lua", "python", "rust", "scheme", "sql",
            "vim", "vimdoc", "squirrel", -- markup
            "css", "html", "markdown", "markdown_inline", "mermaid", "xml", "asm", "make", -- config
            "dot", "toml", "yaml", -- data
            "csv", "json", "json5", "proto", -- utility
            "diff", "ssh_config", "printf", "dockerfile", "git_config", "git_rebase", "gitcommit", "gitignore", "http",
            "query"},
            highlight = {
                enable = true,
